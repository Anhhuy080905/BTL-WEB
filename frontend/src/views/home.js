...
const Home = (props) => {
  return (
    <div className="home-container1">
      <Helmet>
        <title>Mixed Attached Deer</title>
      ...
      <section id="hero-section" role="banner" className="hero">
        <div className="hero__container">
          <div className="hero__content">
            ...
            <nav aria-label="Authentication actions" className="hero__ctas">
              <button
                id="hero-login-btn"
                aria-label="Log in to VolunteerHub"
              ...
              <button
                ...
                aria-label="Register for VolunteerHub"
        ...
        <div className="get-started__container">
          <div className="get-started__panel">
            ...
            <aside className="get-started__role-selection">
              <h3 className="role-selection__title">Chọn vai trò của bạn</h3>
